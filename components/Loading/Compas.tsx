import styles from "@/style/Loading/Compas.module.css";
    ...
    <>
      <div className={styles.compas}>
        ...
        >
          ...
          <g>
            <g className={styles.pl_ringrotate}>
              <circle
                className={styles.pl_ringstroke}
                cx="80"
                cy="80"
                r="72"
                fill="none"
          ...
          <g>
            <g transform="translate(64,28)">
              <g className={styles.pl_arrows} transform="rotate(45,16,52)">
                <path
                  fill="rgb(0, 140, 140)"
